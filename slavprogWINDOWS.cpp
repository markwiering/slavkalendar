...
string geefTeken(int teken)
{
	string t = "";
	switch(teken) //АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ
	{
		case -128: t = "А"; break;
		case -127: t = "Б"; break;
		case -126: t = "В"; break;
		...
		case -89: t = "з"; break;
		case -88: t = "и"; break;
		case -87: t = "й"; break; //АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ
		case -86: t = "к"; break;
		case -85: t = "л"; break;
		case -84: t = "м"; break;
		case -83: t = "н"; break;
		...
		case -10: t = "ў"; break;
		case -9: t = "ў"; break;
		default: t += char(teken);
	}
	return t;
}

string geefTekst(string tekst)
{
	string nw = "";
	loop(tekst) { nw += geefTeken(int(tekst[i])); }
	return nw;
}
